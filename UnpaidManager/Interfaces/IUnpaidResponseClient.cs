...
namespace UnpaidManager.Interfaces
{
    public interface IUnpaidResponseClient
    {
        ...
        Task<IEnumerable<GetAllUnpaidResponseOutput>> GetAllUnpaidResponseAsync(DateTime dateFrom, DateTime dateTo, DateType dateType, CancellationToken cancellationToken);
    }
}
